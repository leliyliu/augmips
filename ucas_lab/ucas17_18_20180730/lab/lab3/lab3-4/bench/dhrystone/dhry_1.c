...
//  Ptr_Glob = (Rec_Pointer) malloc (sizeof (Rec_Type));
  ...
  if(trace_cmp_flag==0){
    ...
    /* display total_ns */
    *((volatile int *)NUM_ADDR) = User_Time;  
    printf ("Begin ns: %lu\n",Begin_Time);
    printf ("End ns: %lu\n",End_Time);
    printf ("Total ns: %lu\n",User_Time);
    ...
    else
    {
      ...
      Microseconds =  User_Time / 1000  
                          /  Number_Of_Runs;
      Dhrystones_Per_Second = 1000000*Number_Of_Runs / (User_Time/1000);
#else
      Microseconds =  User_Time * Mic_secs_Per_Second 
                          / ( HZ * ( Number_Of_Runs));
      Dhrystones_Per_Second = 1000000*( HZ *  Number_Of_Runs)
                          /  User_Time;
#endif
      ...
      printf ("%1u \n", Dhrystones_Per_Second);
      printf ("\n");
      printf ("You set CPU Freq is %luMHz\n", CPU_COUNT_PER_US);
      printf ("So DMIPS/MHZ : %lu/1000\n",1000*Dhrystones_Per_Second/1757/CPU_COUNT_PER_US);
    }
  }
  enable_trace_cmp;
  return pass;  
