...
HD_PWD='/home/innovril/vivado1/2_multiply/2_multiply/2_multiply.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiply_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source multiply_display.tcl
