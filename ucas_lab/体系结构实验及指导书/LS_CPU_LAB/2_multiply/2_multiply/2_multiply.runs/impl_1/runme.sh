...
HD_PWD='/home/innovril/vivado1/2_multiply/2_multiply/2_multiply.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiply_display.vdi -applog -m64 -messageDb vivado.pb -mode batch -source multiply_display.tcl -notrace
