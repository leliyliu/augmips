...
HD_PWD='/home/innovril/vivado1/1_adder/1_adder/1_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source adder_display.tcl
