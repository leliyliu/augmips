...
HD_PWD='/home/innovril/vivado1/1_adder/1_adder/1_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_display.vdi -applog -m64 -messageDb vivado.pb -mode batch -source adder_display.tcl -notrace
