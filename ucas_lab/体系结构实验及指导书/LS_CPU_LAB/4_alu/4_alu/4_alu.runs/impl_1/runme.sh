...
HD_PWD='/home/innovril/vivado1/4_alu/4_alu/4_alu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_display.vdi -applog -m64 -messageDb vivado.pb -mode batch -source alu_display.tcl -notrace
