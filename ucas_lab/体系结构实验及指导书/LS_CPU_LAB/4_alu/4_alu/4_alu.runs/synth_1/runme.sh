...
HD_PWD='/home/innovril/vivado1/4_alu/4_alu/4_alu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source alu_display.tcl
