...
HD_PWD='/home/innovril/vivado1/3_regfile/3_regfile/3_regfile.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log regfile_display.vdi -applog -m64 -messageDb vivado.pb -mode batch -source regfile_display.tcl -notrace
