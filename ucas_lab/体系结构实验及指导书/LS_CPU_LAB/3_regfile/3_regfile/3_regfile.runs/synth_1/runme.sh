...
HD_PWD='/home/innovril/vivado1/3_regfile/3_regfile/3_regfile.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log regfile_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source regfile_display.tcl
