...
HD_PWD='/home/innovril/vivado1/8_pipeline_cpu/8_pipeline_cpu/8_pipeline_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeline_cpu_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pipeline_cpu_display.tcl
