...
# Script info
echo -e "inst_rom.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L unisims_ver -L unimacro_ver -L secureip --snapshot inst_rom xil_defaultlib.inst_rom xil_defaultlib.glbl -log elaborate.log
}
