...
HD_PWD='/home/innovril/vivado1/7_multi_cycle_cpu/7_multi_cycle_cpu/7_multi_cycle_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_cycle_cpu_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source multi_cycle_cpu_display.tcl
