...
HD_PWD='/home/innovril/vivado1/7_multi_cycle_cpu/7_multi_cycle_cpu/7_multi_cycle_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_cycle_cpu_display.vdi -applog -m64 -messageDb vivado.pb -mode batch -source multi_cycle_cpu_display.tcl -notrace
