...
HD_PWD='/home/innovril/vivado1/6_single_cycle_cpu/6_single_cycle_cpu/6_single_cycle_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_cycle_cpu_display.vdi -applog -m64 -messageDb vivado.pb -mode batch -source single_cycle_cpu_display.tcl -notrace
