...
HD_PWD='/home/innovril/vivado1/6_single_cycle_cpu/6_single_cycle_cpu/6_single_cycle_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_cycle_cpu_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source single_cycle_cpu_display.tcl
